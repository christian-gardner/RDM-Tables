DROP TABLE SQA_ICC_PRIOR_HISTORY_STG CASCADE CONSTRAINTS;

CREATE TABLE SQA_ICC_PRIOR_HISTORY_STG
(
  PID                  NUMBER,
...
GRANT DELETE, SELECT, UPDATE ON SQA_ICC_PRIOR_HISTORY_STG TO IPP$LIBRARIAN;
